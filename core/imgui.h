...
struct ImGuiIO
{
    ...
    bool        ConfigUseDefaultMouseCursors;   // = false          // Request ImGui to draw hand cursor for buttons, resize cursors for sliders, scrollbars and drag widgets, as well as resize-all cursor for drag & drop
