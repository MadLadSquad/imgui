...
//#endif
    ...
    IMGUI_API bool          ButtonBehavior(const ImRect& bb, ImGuiID id, bool* out_hovered, bool* out_held, ImGuiButtonFlags flags = 0, ImGuiMouseCursor cursor = ImGuiMouseCursor_Hand);
